...
export default function TopBar({ setAddShowModal }) {
  const [showModal, setShowModal] = React.useState(false);
  // console.log(setAddShowModal);

  return (
    <Popover className="relative bg-[#31006e]">
      <div className="px-0 mx-0 max-w-100 sm:px-0">
        <div className="flex items-center justify-between px-4 py-4 border-b-2 border-gray-100 md:justify-start md:space-x-10 sm:px-6">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              <span className="sr-only">Your Company</span>
              <img
                className="w-auto h-14 sm:h-12"
                src={`https://media-exp1.licdn.com/dms/image/C4E0BAQHbHlLwL6DNEA/company-logo_200_200/0/1569597462853?e=2147483647&v=beta&t=dbLq7GIlF5MMxf_VJXqjtUrpLa7op-A6sf4Ksl7MN5Q`}
                alt=""
              />
            </a>
          </div>
